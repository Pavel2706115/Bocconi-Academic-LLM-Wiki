...
7.72% under the base case assumptions. This is the return that DraftKings must earn to generate value for its shareholders and should be used as a guide to future investments.
