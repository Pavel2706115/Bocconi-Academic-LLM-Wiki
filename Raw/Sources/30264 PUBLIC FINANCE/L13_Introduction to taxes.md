...
- **Slide 2: Why study taxation?**
	1. Slide elements:
		- **Text:**
			- Taxes are economically large. In advanced economies, taxes finance a substantial share of public sharing. Tax revenue typically amounts to 30-45% of GDP. Italy is above the OECD average, but so are many European countries.
...
- **Slide 9: Tax structures in 2023 (as % of total tax revenue)**
	1. Slide elements:
		- **Visuals:** Stacked bar chart showing tax composition across countries
			...
			- **X-axis:** Country codes, grouped into three main sections:
				- “Income taxes”
...
- **Slide 25: Revenue from property taxes as share of total tax revenues, 2023 vs 2013**
	...
	2. Explanation of content:
		...
		- **Key takeaways from visuals:**
			- Italy's reliance on property taxes has fallen significantly over the last decade (the 2013 light blue dash is near 10%, white the 2023 bar is near 5.5%)
