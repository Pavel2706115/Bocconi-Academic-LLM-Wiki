...
*(See also: [[Accounting 1 Blab Handout 2024-2025 A.Y.#^f1zsez]])*
...
While learning, it is better to use the symbols A, L and SE next to each account title in the journal entries. For example, if cash is to be increased, we can write “Cash (+A)”. In addition, dollar signs are not needed. ^i3r6lm
