...
## The variance: characteristics**: Without loss of generality we focus on the **sample variance
...
*(See also: [[Statistics_Formula_Sheet_Bocconi#^ucjp1h]])*
...
|**Income**|**_fk__k_**|**_mk_**|**_mk_- ****_pk_**|**_m_2****_k_**- **_pk_**|
|---|---|---|---|---|---|
