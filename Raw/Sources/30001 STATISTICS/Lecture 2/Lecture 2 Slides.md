...
**==> picture [356 x 115] intentionally omitted <==**

**==> picture [369 x 99] intentionally omitted <==**
...
**==> picture [816 x 142] intentionally omitted <==**

**----- Start of picture text -----**<br>
> length(x)<br>[1] 7<br>> x<br>Berlin Paris Amsterdam Stockholm Lisbon Madrid      Rome<br>1         5         8         0         1        10         3<br>> names(x)<br>[1] "Berlin"    "Paris"     "Amsterdam" "Stockholm" "Lisbon"    "Madrid"<br>[7] "Rome"<br>**----- End of picture text -----**<br>
...
**==> picture [675 x 125] intentionally omitted <==**

**----- Start of picture text -----**<br>
[1] "North" "North" "North" "North" "South" "South" "South"<br>> s.n<br>[1]  TRUE  TRUE TRUE TRUE FALSE FALSE FALSE<br>> x.sub5 # identical to x.sub6<br>Berlin Paris Amsterdam Stockholm<br>1         5         8         0<br>> x.new<br>Berlin Paris Amsterdam Stockholm Lisbon Madrid      Rome<br>0         5         8         0         0        10         0<br>**----- End of picture text -----**<br>
...
## **Matrices: indexing and selection [OPTIONAL]** 
...
**==> picture [384 x 326] intentionally omitted <==**
...
## **Dataframe: creation from scratch [OPTIONAL]** 
...
## **Dataframe: structure and attributes [OPTIONAL]** 
...
## **Lists: indexing and selection [OPTIONAL]** 
