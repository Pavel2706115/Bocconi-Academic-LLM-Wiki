...
**==> picture [391 x 294] intentionally omitted <==**
...
**==> picture [711 x 221] intentionally omitted <==**
...
- Analytically **describe** the linear relationship between the dependent variable and the explanatory variable 

- **Predict** the dependent variable based on the observed values of the explanatory variable using the estimated model 
...
**==> picture [490 x 291] intentionally omitted <==**
...
**----- Start of picture text -----**<br>
No data<br>**----- End of picture text -----**<br>


**Estimated intercept,** 𝒃𝟎 

= 𝟐𝟑𝟏. 𝟐𝟎+ 𝟏𝟒. 𝟔𝟒∙𝒙 ෝ𝒚𝒊 𝒊 

**Estimated slope,** 𝒃𝟏 **.** 

**Please note:** 𝒃𝟎 **cannot be interpreted as 'time spent on chat by subjects aged 0'. There is no information on subjects aged less than 20 (no predictions should be obtained corresponding to values outside the range of** 𝑿 **).** 

**For each additional year of age, based on the regression line, time spent on chat is 'expected' to increase on average by** 𝒃𝟏 **= 14.64 minutes (approximately, rounded coefficient)** 
...
**==> picture [493 x 67] intentionally omitted <==**
...
 The sum of the **squares of the regression (** 𝑺𝑺𝑹 ), the sum of the squared deviations of the predictions ො𝑦1, ො𝑦2, … , ො𝑦𝑛 from the mean of the dependent variable 
...
**----- Start of picture text -----**<br>
x =55;<br>=1378<br>y<br>ഥ𝒚= 𝟖𝟎𝟗. 𝟏𝟒<br>**----- End of picture text -----**<br>
...
**----- Start of picture text -----**<br>
=  𝒃 +  𝒃 𝒙<br>ෝ𝒚 𝟎 𝟏<br>ത𝑦<br>ෝ ഥ<br>−<br>𝒚𝒊 𝒚<br>𝒚𝒊 −ഥ𝒚<br>𝒚𝒊 −ෝ𝒚𝒊<br>𝑦𝑖<br>𝑥𝑖<br>**----- End of picture text -----**<br>
...
**==> picture [221 x 380] intentionally omitted <==**
...
𝑺𝑺𝑹 =0: the regression line coincides with a line with zero slope and intercept equal to the mean of the dependent variable 
...
𝑏 = 𝑠 : It is worth noting that (since 1 𝑥𝑦 /𝑠𝑥[2] ) 
...
In order to study the properties of these estimators, it is necessary - as always - to make **assumptions** on the characteristics of the distribution of _Y_ or, equivalently, on the characteristics of the distribution of the unique random component of the linear model: 
...
_Y_ 𝑥+ ε _Y_ 𝑥 for each 𝑖 = β0 + β1 𝐸( 𝑖) = β0 + β1 𝑖 Thus, the information on 𝑿 makes it possible to explain the **expected values** of _Y_ 𝑖 (but **not** the specific realisations _Y_ 𝑖 ) and there are no other factors that systematically influence 𝐸( _Y_ 𝑖) _Y x_ 𝑬( 3) β0 + β1 3 **The expected value of** _**Y**_ **varies** 𝑿 **. linearly with** _Y_ 𝑥 𝑬( 2) β0 +β1 2 **It is assumed that there are no other factors that systematically influence** _**Y**_ **i.e. that the** 𝑬 _Y_ β0 +β1 𝑥1 ( 1) **differences in the expected values of** _**Y**_ **are only due to** 𝑿 **(or that** 𝑿 **is sufficient to explain them)** _**x x x**_ **1 2 3** 

**32** 

## **Weak assumptions** 

The error term is a r.v. with constant variance, σε[2] whatever _xi_ ( **homoskedasticity** ): 𝑉𝑎𝑟 ε𝑖 = σε[2] for every 𝑖 = _Y_ 𝑥+ ε _Y_ σ for each 𝑖 = β0 + β1 𝑉𝑎𝑟( 𝑖) ε[2] 

_**Y x**_ Thus, the variance (and standard deviation) of _**i**_ does not depend on _**i** :_ 

_x_ β0 + β1 3 𝑥 β0 +β1 2 𝑥 β0 +β1 1 

**==> picture [296 x 206] intentionally omitted <==**

**The standard deviation (the amount of dispersion around the line) remains constant as** 𝑿 **changes. Thus, although they have different expected values, the** _**Yi**_ **have the same variance (they can be considered a homogeneous sample with reference to the squared deviation from the mean)** 
...
**==> picture [760 x 166] intentionally omitted <==**
...
- Are **unbiased** for the population parameters 𝐸(β[෠] 1) = 𝛃𝟏 

   - 𝐸(β[෠] 0) = 𝛃𝟎 

**==> picture [785 x 129] intentionally omitted <==**
...
The **estimate** of the parameter 𝜎ε[2] at a specific sample realisation 𝑦1, … , 𝑦𝑛 is: 

𝑛 − 𝑏 +𝑏 𝑥 𝑺𝑺𝑬 [𝑦𝑖 ( 0 1 𝑖)][2] 𝑠 = ε[2] = ෍ (𝑛−2) (𝑛−2)[= 𝑴𝑺𝑬] 𝑖=1 

also called the **mean of the squares of the errors** ( 𝑴𝑺𝑬 ), given by the **sum of the squares of the errors (** 𝑺𝑺𝑬 ) divided by (𝑛−2) 

Thus, the deviations of the 𝑦𝑖 observed around the estimated line are considered estimates of the model errors, and the 𝑺𝑺𝑬 is used to estimate the dispersion. 

The estimate of  is  

𝑺𝑺𝑬 𝒔 = 𝛆 (𝑛−2) 

**standard error of the model or standard error of residuals** 
...
It is not possible to assess the reliability of the estimate but only of the **estimator.** The observed estimate is just one of the possible realisations of the estimator. Remember that 𝑛= 96 , 𝑠𝑥[2] = 88.06 , 𝑠𝑦[2] = 30237.95 , and 𝑅[2] = 0.6241 . Therefore: 2 = 𝑆𝑆𝐸= (1 −𝑅[2] ) ∙𝑆𝑆𝑇= (1 −𝑅[2] ) ∙(𝑛−1)𝑠𝑦 1 −0.6241 ∙95 ∙30237.95 = 1079812.31 𝑠 ε[2] = 𝑆𝑆𝐸/(𝑛−2) = 1079812.314/94 = 11487.37 and: The (estimate of the) expected deviation of 2 sε 11487.37 a generic estimate of the slope from the 𝒔𝒆 = ෡𝛃𝟏 2[=] 95 ∙88.06[= 1.1718] parameter 𝛃𝟏𝟏 is **1.1718** (𝑛−1)𝑠𝑥 

The (estimate of the) expected deviation of a generic estimate of the slope from the parameter 𝛃𝟏𝟏 is **1.1718** 
...
To apply more advanced inferential techniques, e.g. constructing confidence intervals or **determine the distribution of**[መ] **.** testing hypotheses, it is necessary to 𝛽0 **and** 𝛽[መ] 1 For this purpose - at least when the sample size is not very large - it is necessary to make a further assumption on the **distribution of model errors** , in addition to the weak ones already assumed. 

**Weak assumptions: :** 𝐸 ε𝑖 = 0 and 𝑉𝑎𝑟 ε𝑖 = σε[2] f or each 𝑖 ; 𝐶𝑜𝑟(ε𝑖, εℎ) = 0 f or each 𝑖, ℎ ~ **+ The error**  **has normal distribution:** ε **Strong assumptions: Weak assumptions** 𝑖 𝒩(0, σε[2] ) 
...
**==> picture [777 x 334] intentionally omitted <==**
...
𝑬(𝛃[෡] 𝟎) = 𝛃𝟎 1 ҧ𝑥[2] 𝑽𝒂𝒓(𝛃[෡] 𝟎) = σε[2] 2 𝑛[+] (𝑛−1)𝑠𝑥 

**==> picture [196 x 81] intentionally omitted <==**

**----- Start of picture text -----**<br>
𝑬(𝛃 [෡] 𝟏) = 𝛃𝟏<br>σ<br>ε [2]<br>𝑽𝒂𝒓(𝛃 [෡] 𝟏) = 2<br>(𝑛−1)𝑠𝑥<br>**----- End of picture text -----**<br>


## Under **strong assumptions** : 

෡ 1 ҧ𝑥[2] 𝛃𝟎 ~𝒩 β0, σε[2] 𝑛[+] (𝑛−1)𝑠𝑥[2] 

෡ σε[2] 𝛃𝟏 ~𝒩 β1, (𝑛−1)𝑠𝑥[2] 
...
**==> picture [315 x 118] intentionally omitted <==**
...
**==> picture [287 x 104] intentionally omitted <==**
...
**==> picture [611 x 78] intentionally omitted <==**
...
**==> picture [624 x 226] intentionally omitted <==**
...
**==> picture [274 x 57] intentionally omitted <==**
...
**==> picture [534 x 289] intentionally omitted <==**
...
**==> picture [516 x 23] intentionally omitted <==**
...
**==> picture [776 x 170] intentionally omitted <==**

**==> picture [584 x 99] intentionally omitted <==**
...
**==> picture [796 x 135] intentionally omitted <==**

## Therefore: 

**==> picture [618 x 99] intentionally omitted <==**

The confidence interval for _Y_ is **much** wider than that one determined for μ 𝑔 𝑔 

**==> picture [434 x 16] intentionally omitted <==**
...
```
 ...
 $ residuals : Named num [1:99] 4.81 1.3 3.79 -1.42 -2.68 ...
  ..- attr(*, "names")= chr [1:99] "1" "2" "3" "4" ...
```

```
 $ effects : Named num [1:99] -669.31 -166.19 3.44 -1.87 -3.04 ...
  ..- attr(*, "names")= chr [1:99] "(Intercept)" "income" "" ...
 $ rank : int 2
```

```
 $ fitted.values: Named num [1:99] 37.8 70.1 46.1 65.3 48.2 ...
  ..- attr(*, "names")= chr [1:99] "1" "2" "3" "4" ...
```
...
**==> picture [734 x 19] intentionally omitted <==**
...
**==> picture [442 x 271] intentionally omitted <==**
...
```
> distr.plot.x(sreg.model$residuals,plot.type="histogram")
> distr.plot.x(rstandard(sreg.model),plot.type="histogram")
```

**==> picture [327 x 228] intentionally omitted <==**

**==> picture [323 x 227] intentionally omitted <==**
...
```
> sreg.ads<-lm(sales ~ facebook , data=Advertising)
> plot(sreg.ads,which=1)
> plot(sreg.ads,which=3)
```
...
**==> picture [622 x 163] intentionally omitted <==**
...
**==> picture [635 x 294] intentionally omitted <==**
...
**==> picture [466 x 312] intentionally omitted <==**
...
**==> picture [434 x 290] intentionally omitted <==**
