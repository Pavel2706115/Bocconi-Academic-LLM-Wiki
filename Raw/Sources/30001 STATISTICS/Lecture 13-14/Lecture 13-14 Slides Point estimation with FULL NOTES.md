...
For a generic ~~**unbiased** estimator θ~~(\hat{P}) ~~for a paramet~~ er θ, i.e. such that E(θ)(\hat{P}) = θ: 2 2 E \hat{θ} −θ = E \hat{θ} −E(\hat{θ}) = Var(\hat{θ})
