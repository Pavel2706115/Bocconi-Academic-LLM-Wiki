...
In addition, the ~~multiple regression model allows to study the relationship between the dependent~~ variable and more explanatory variables, and to take into account/ **control for** factors that possibly i ~~nfluence the dependent variable~~ (Simpson's paradox) 
...
**==> picture [759 x 345] intentionally omitted <==**

**----- Start of picture text -----**<br>
Y<br>𝒙 𝒙<br>𝛃𝟎 + 𝛃𝟏 𝟏 + 𝛃𝟐 𝟐<br>Multiple regression:<br>2 variables<br>Simple regression:<br>∗ a single<br>𝒙 𝒙<br>𝛃𝟎 + 𝛃𝟏 𝟏 + 𝛃𝟐 𝟐 explanatory<br>variable<br>𝒙<br>𝛃𝟎 + 𝛃𝟏 𝟏<br>𝑿<br>𝛃𝟎 𝟐<br>The single straight line<br>∗<br>𝒙<br>spans to a plane 𝟐<br>𝑿<br>𝟏<br>**----- End of picture text -----**<br>
...
**==> picture [400 x 345] intentionally omitted <==**

**----- Start of picture text -----**<br>
Y<br>𝑿<br>𝟐<br>∗<br>𝒙<br>𝟐<br>∗<br>𝒙<br>𝟏 𝑿<br>𝟏<br>**----- End of picture text -----**<br>


**==> picture [234 x 20] intentionally omitted <==**

**----- Start of picture text -----**<br>
Y 𝒙 𝒙 + e<br> = 𝛃𝟎 + 𝛃𝟏 𝟏 + 𝛃𝟐 𝟐<br>**----- End of picture text -----**<br>
...
**Y** 𝒚𝒊 𝒀 Consider a data sample and a **generic** 𝑒 𝑖 = (𝑦𝑖 −ො𝑦𝑖 ) **model** with parameters 𝑏0 , 𝑏1 and 𝑏 . 2 For a sample observation we consider  the forecast ො𝑦𝑖 ො𝑦𝑖 = 𝑏0 + 𝑏1 𝑥𝑖1 + 𝑏2 𝑥𝑖2  the deviation between the observed value and the value on 𝑿 𝟐 the line, 𝑒𝑖 = 𝑦𝑖 −ො𝑦𝑖 **Among all the possible planes, we** 𝒙 𝒊𝟐 **choose the one that minimizes the sum of the squared errors** 𝒙 𝒊𝟏 𝑿 𝟏 
...
𝑦𝑖 value of _**Y**_ corresponding to 𝑥𝑖1, 𝑥𝑖1, … , 𝑥𝑖𝐾 ො𝑦𝑖 = 𝑏0 + 𝑏1 𝑥𝑖1 + 𝑏2 𝑥𝑖2 + … + 𝑏𝐾 𝑥𝑖𝐾 forecast of _**Y**_ corresponding to 𝑥𝑖1, 𝑥𝑖1, … , 𝑥𝑖𝐾 

Let us consider the sum of the squared differences between the observed values and the ∗ ∗ ∗ predictions ො𝑦1, ො𝑦2, … , ො𝑦𝑛, i.e. the Sum of Squared Errors: 𝑛 𝑛 𝑺𝑺𝑬 −𝑏 −𝑏 𝑥 𝑥 … −𝑏 𝑥 (𝑦𝑖 −ො𝑦𝑖 )[2] (𝑦𝑖 0 1 𝑖1 −𝑏2 𝑖2 − 𝐾 𝑖𝐾)[2] = ෍ = ෍ 𝑖=1 𝑖=1 
...
## **Least squares: determination of coefficients [OPTIONAL]** 
...
The **Prices*** dataframe contains information on the weekly sales ( **Sales** , in appropriate units) of a product, the price ( **Price** ) at which it was offered (at a certain shop, as a percentage) and the price at which the main competing product was offered ( **Price.Comp** , percentage). 

**==> picture [283 x 208] intentionally omitted <==**

**> distr.plot.xy(x=Price,y=Sales, +               plot.type="scatter", +               fitline=T, data=Sales)** 
...
**> plot(reg.price,which=1) > distr.plot.xy(Sales$Price.Comp, +               rstandard(reg.price), +               plot.type='scatter')** 
...
**+               plot.type="scatter", +               fitline=T, data=Sales)** 

**> regr.comp<-lm(Sales ~ Price.Comp,** 

**+               data = Sales) > regr.comp Coefficients:** 

**(Intercept) Price.Comp 40.715      1.181** 
...
**> regr.sales<-lm(Sales ~ Price+Price.Comp, +                data = Sales) > regr.sales Coefficients: (Intercept)  Price Price.Comp 119.314 -1.284      1.039** 
...
To assess the explanatory power of the multiple regression model, we refer to the **sum of squared errors** (data vs. predictions based on least squares coefficients) 𝑛 𝑛 𝑺𝑺𝑬 −𝑏 𝑥 𝑥 … −𝑏 𝑥 (𝑦𝑖 −ො𝑦𝑖)[2] (𝑦𝑖 0 −𝑏1 𝑖1 −𝑏2 𝑖2 − 𝐾 𝑖𝐾)[2] = ෍ = ෍ 𝑖=1 𝑖=1 

## : and the decomposition of the **sum of squares total** 

**==> picture [591 x 228] intentionally omitted <==**

**----- Start of picture text -----**<br>
𝑛<br>(𝑦𝑖 −ത𝑦) [2] = (𝑛−1)𝑠𝑦 [2]<br>𝑺𝑺𝑻= ෍<br>𝑖=1<br>𝑛 𝑛<br>𝑺𝑺𝑹 𝑺𝑺𝑬<br>(ො𝑦𝑖 −ത𝑦) [2] (𝑦𝑖 −ො𝑦𝑖) [2]<br>= ෍ = ෍<br>𝑖=1 𝑖=1<br>Sum of squares of errors<br>**----- End of picture text -----**<br>
...
**==> picture [900 x 45] intentionally omitted <==**

**----- Start of picture text -----**<br>
19<br>**----- End of picture text -----**<br>


## **The coefficient of determination [READING]** 
...
**==> picture [48 x 114] intentionally omitted <==**

**----- Start of picture text -----**<br>
R [2]<br>Adj-R [2]<br>**----- End of picture text -----**<br>
...
**==> picture [279 x 20] intentionally omitted <==**
...
**> tstat_Price<-(-1.28361/0.13085) # rounded values > pvalue_Price<-2*(1-pt(abs(tstat_Price),df=97)) > print(c(tstat_Price,pvalue_Price))** 
...
**----- Start of picture text -----**<br>
~<br>F  |  H0  F 𝑲,(𝒏−𝑲−𝟏)<br>**----- End of picture text -----**<br>
...
**----- Start of picture text -----**<br>
<br>F<br>α;𝐾,(𝑛−𝐾−1)<br>Don’t Reject H 0 Reject H0<br>**----- End of picture text -----**<br>
...
**Observed value of the** _**F-statistic**_ **and its p-value. Conclusions?** 
...
**> newdata<-data.frame(Price=50,Price.Comp=c(25,50,75)) > predict(reg_sales,newdata=newdata, +         interval='confidence',level=0.95) fit       lwr       upr 1  81.11674  71.82766  90.40581 2 107.10009 101.44271 112.75746 3 133.08344 128.93195 137.23492** 
...
**> predict(reg_sales,newdata=newdata, +         interval="prediction",level=0.95) fit      lwr      upr 1  81.11674 39.85291 122.3806 2 107.10009 66.49931 147.7009 3 133.08344 92.66498 173.5019** 
...
**distr.plot.xy(x=Loyalty,y=Retention,plot.type="scatter", fitline=TRUE,bw=TRUE,data=Retention) distr.plot.xy(x=SalesPersons,y=Retention,plot.type="scatter", fitline=TRUE,bw=TRUE,data=Retention) summary(lm(Retention ~ Loyalty, data = Retention)) summary(lm(Retention ~ SalesPersons, data = Retention))** 
...
**> regr.loyalty<-lm(Retention ~ Loyalty, data = Retention) > distr.plot.xy(x=SalesPersons,y=rstandard((regr.loyalty)), plot.type="scatter",fitline=TRUE,bw=TRUE,data=Retention)** 
...
**> confint(regr.retention) 2.5 %    97.5 % (Intercept)  9.636895 15.226158 Loyalty      4.636540  5.100068 SalesPersons 7.757942 15.538303** 
...
**> regr.bank<-lm(Profit ~ Wealth, data = Bank.Invest) > summary(regr.bank)** 

## **Coefficients:** 

**Estimate Std. Error t value Pr(>|t|) (Intercept) 42.84728   10.13984   4.226 3.8e-05 *** Wealth       0.06311    0.00286  22.065 < 2e-16 *** ---** 

## _Selected Output_ 

**Signif. codes: 0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' 1 Residual standard error: 54.83 on 178 degrees of freedom Multiple R-squared: 0.7323, Adjusted R-squared: 0.7308 F-statistic: 486.9 on 1 and 178 DF, p-value: < 2.2e-16** 
...
**plot(regr.bank,which=1) plot(regr.bank,which=3) distr.plot.x(regr.bank$residuals,plot.type="histogram")** 

**==> picture [305 x 199] intentionally omitted <==**

**==> picture [244 x 203] intentionally omitted <==**
...
**> distr.plot.xy(x=regr.bank$fitted.values, +               y=regr.bank$residuals, +               plot.type="scatter", +               var.c=Bank.Invest$Strategy)** 
...
**==> picture [519 x 313] intentionally omitted <==**
...
**Coefficients: Estimate Std. Error t value Pr(>|t|) (Intercept) -11.974381   6.345635  -1.887   0.0608 . Wealth        0.063049   0.001556  40.532   <2e-16 *** StrategyB    52.811764   5.444007   9.701   <2e-16 *** StrategyC   112.280339   5.444015  20.625   <2e-16 ***** 

**How do you interpret the coefficients related to the adopted strategy?** _The coefficients of the dummy variables for the levels of the variable_ **Strategy** _indicate the estimated mean difference in profit when a strategy alternative to A (which is the reference category) is adopted, keeping_ **Wealth** _fixed. For example, considering_ _**customers with the same Wealth** , adopting strategy B entails an expected and significant increase in profit of 52 units compared to adopting strategy A; a similar interpretation holds for strategy C_ 
...
**0.5 %     99.5 % (Intercept) -77.93146121 14.9974126 Ads.Exp       0.06738164  0.1032639 Radio         2.64063581  4.0816383 Popularity    0.49102435  1.7186209** 
...
**plot(regr.music,which=1) plot(regr.music,which=3) distr.plot.x(regr.music$residuals,plot.type="histogram")** 
...
**==> picture [287 x 238] intentionally omitted <==**

**==> picture [287 x 239] intentionally omitted <==**
...
**> regr.music<-lm(Sales ~ Ads.Exp+Radio+Popularity+International+Genre, +                data = Downloads) > summary(regr.music) Coefficients:** 

**Would you prefer this model to the simpler one?** 

**Estimate Std. Error t value Pr(>|t|) (Intercept)      -36.221914  16.993992  -2.131 0.034317 * Ads.Exp            0.072678   0.006535  11.121  < 2e-16 *** Radio              2.702598   0.267029  10.121  < 2e-16 *** Popularity         1.059742   0.211760   5.004 1.26e-06 *** InternationalYes  41.114589   8.360607   4.918 1.87e-06 *** Genrepop          47.852953  10.435878   4.585 8.13e-06 *** Genreelectronic   27.751379   8.132335   3.412 0.000784 *** --Signif** **`. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1` Residual standard error: 41.97 on 193 degrees of freedom Multiple R-squared:  0.7376, Adjusted R-squared:  0.7295 F-statistic: 90.44 on 6 and 193 DF,  p-value: < 2.2e-16** 
...
**> reg_house<-lm(Price ~ Bedrooms+HSize+LSize, +               data = House) > summary(reg_house) Coefficients:** 

**Estimate Std. Error t value Pr(>|t|) (Intercept) 42669.838  15166.580   2.813  0.00612 ** Bedrooms    -1573.490   7731.835  -0.204  0.83924 HSize          58.898     57.080   1.032  0.30514 LSize           2.685     18.557   0.145  0.88531 ---** 

**Residual standard error: 24920 on 83 degrees of freedom Multiple R-squared:  0.5599, Adjusted R-squared:  0.544 F-statistic: 35.19 on 3 and 83 DF,  p-value: 8.961e-15** 
...
**==> picture [817 x 44] intentionally omitted <==**

**----- Start of picture text -----**<br>
ො𝑦= 29337 + 34907 ∙𝐵𝑒𝑑𝑟𝑜𝑜𝑚𝑠 ො𝑦= 40971 + 64.919 ∙𝐻𝑆𝑖𝑧𝑒 ො𝑦= 40007 + 21.212 ∙𝐿𝑆𝑖𝑧𝑒<br>𝑅 [2] = 0.398 𝑅 [2] = 0.556 𝑅 [2] = 0.554<br>**----- End of picture text -----**<br>
...
**> cor(House) Price  Bedrooms     HSize     LSize Price    1.0000000 0.6306415 0.7480247 0.7444450 Bedrooms 0.6306415 1.0000000 0.8531433 0.8499681 HSize    0.7480247 0.8531433 1.0000000 0.9937202 LSize    0.7444450 0.8499681 0.9937202 1.0000000** 
...
**> reg_house<-lm(Price ~ HSize, data = House) > summary(reg_house) Coefficients:** 

**Estimate Std. Error t value Pr(>|t|) (Intercept) 40970.982  11392.034   3.596 0.000541 *** HSize          64.919      6.247  10.391  < 2e-16 *** ---** 

**Signif** **`. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1`** 

**Residual standard error: 24640 on 85 degrees of freedom Multiple R-squared:  0.5595, Adjusted R-squared:  0.5544 F-statistic:   108 on 1 and 85 DF,  p-value: < 2.2e-16** 
...
**==> picture [751 x 408] intentionally omitted <==**
...
|margin (%)|
|Profitability|
|Competition|Mkt awareness|Demand generators|Community|Location quality|
|Number|Nearest|Office|College|Income|Distance|
|enrollment|
|space|
|Median|
|Nr of rooms|Distance to|Demand generators:|household|Distance|
|within 3|the nearest|offices (thousands sq.ft)|income|from the|
|miles.|competitor|and number of students|(thousands|centre|
|(thousands)|dollars)|
...
**==> picture [640 x 136] intentionally omitted <==**

**----- Start of picture text -----**<br>
Margin Number Nearest Office Space Enrollment Income Distance<br>55.5 3203 4.2 549 8 37 2.7<br>33.8 2810 2.8 496 17.5 35 14.4<br>49 2890 2.4 254 20 35 2.6<br>31.9 3422 3.3 434 15.5 38 12.1<br>57.4 2687 0.9 678 15.5 42 6.9<br>49 3759 2.9 635 19 33 10.8<br>**----- End of picture text -----**<br>
...
**Residual standard error: 5.512 on 93 degrees of freedom Multiple R-squared: 0.5251, Adjusted R-squared: 0.4944 F-statistic: 17.14 on 6 and 93 DF, p-value: 3.034e-13** 
...
**==> picture [330 x 225] intentionally omitted <==**
...
## **Normality and Homoschedasticity Tests [OPTIONAL]** 
...
**==> picture [312 x 214] intentionally omitted <==**
...
**> reg_hotel<-lm(Margin ~ Number+Nearest+Office+Enrollment+Income+Distance, +               data = Hotel)** 
...
**Estimate Std. Error t value Pr(>|t|) (Intercept) 38.138575   6.992948   5.454 4.04e-07 *** Number      -0.007618   0.001255  -6.069 2.77e-08 *** Nearest      1.646237   0.632837   2.601   0.0108 * Office       0.019766   0.003410   5.796 9.24e-08 *** Enrollment   0.211783   0.133428   1.587   0.1159 Income       0.413122   0.139552   2.960   0.0039 ** Distance    -0.225258   0.178709  -1.260   0.2107 --Residual standard error: 5.512 on 93 degrees of freedom Multiple R-squared:  0.5251, Adjusted R-squared:  0.4944 F-statistic: 17.14 on 6 and 93 DF,  p-value: 3.034e-13** 
...
**> to_predict <- data.frame(Number= 3815,Nearest=0.9,Office=476,Income=35, +                          Distance=11.2,Enrollment=24.5)** 

**>** 

**> predict(reg_hotel, to_predict,interval = "confidence", level = 0.95) fit      lwr      upr** 

- **1 37.09149 32.96972 41.21326** 

**> predict(reg_hotel, to_predict,interval = "prediction", level = 0.95) fit      lwr      upr 1 37.09149 25.39525 48.78772** 
...
**> predict(reg_hotel, to_predict,interval = "confidence", level = 0.95) fit      lwr      upr 1 37.09149 32.96972 41.21326** 
...
**> conf.pred<-predict(reg_hotel, Hotel,interval = "confidence",level = 0.95) > pred.pred<-predict(reg_hotel, Hotel,interval = "prediction",level = 0.95) > conf.pred[87,]** 

**fit      lwr      upr 57.81456 54.08090 61.54823** 

**> pred.pred[87,] fit      lwr      upr 57.81456 46.24939 69.37973** 
