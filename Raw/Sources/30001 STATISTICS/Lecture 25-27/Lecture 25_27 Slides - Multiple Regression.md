...
ො𝑦𝑖 = 𝑏0 + 𝑏1 𝑥𝑖1 + 𝑏2 𝑥𝑖2 + … + 𝑏𝐾 𝑥𝑖𝐾 forecast of _**Y**_ corresponding to 𝑥𝑖1, 𝑥𝑖1, … , 𝑥𝑖𝐾 
...
**----- Start of picture text -----**<br>
<br>F<br>α;𝐾,(𝑛−𝐾−1)<br>**----- End of picture text -----**<br>


**==> picture [207 x 23] intentionally omitted <==**

**----- Start of picture text -----**<br>
Don’t Reject H0<br>**----- End of picture text -----**<br>


**==> picture [191 x 22] intentionally omitted <==**

**----- Start of picture text -----**<br>
Reject H0<br>**----- End of picture text -----**<br>
