...
**==> picture [492 x 186] intentionally omitted <==**
...
**==> picture [274 x 275] intentionally omitted <==**
...
**==> picture [284 x 283] intentionally omitted <==**
...
**==> picture [310 x 251] intentionally omitted <==**
...
**==> picture [376 x 306] intentionally omitted <==**
...
**==> picture [392 x 302] intentionally omitted <==**
...
**==> picture [279 x 189] intentionally omitted <==**

**==> picture [273 x 186] intentionally omitted <==**

**==> picture [278 x 189] intentionally omitted <==**
...
**==> picture [786 x 52] intentionally omitted <==**

} The **sample covariance** instead is defined as: 

**==> picture [742 x 51] intentionally omitted <==**
...
**==> picture [613 x 124] intentionally omitted <==**
...
**==> picture [586 x 233] intentionally omitted <==**

## In the case of a **population,** the same reasoning leads to: 

**==> picture [420 x 79] intentionally omitted <==**
...
**==> picture [601 x 194] intentionally omitted <==**
...
**==> picture [272 x 144] intentionally omitted <==**
...
**==> picture [273 x 185] intentionally omitted <==**
...
**==> picture [232 x 158] intentionally omitted <==**
...
**==> picture [464 x 337] intentionally omitted <==**
